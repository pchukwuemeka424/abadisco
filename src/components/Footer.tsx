...
const Footer = ({ footerCategories }: FooterProps) => (
  <footer className="bg-gray-900 text-white py-12 px-4">
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="text-xl font-bold mb-4">Aba Traders</h3>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">© 2025 Aba Traders. All rights reserved.</p>
          <p className="text-gray-400 text-xs mt-2">Designed by Acehub Technology Ltd UK</p>
          <p className="text-gray-400 text-xs mt-1">Company Number 16475209</p>
        </div>
      </div>
    </div>
  </footer>
