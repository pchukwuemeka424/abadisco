    ...
    <div className="min-h-screen flex bg-gray-50/50">
      <main className="flex-1 p-6 md:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Upload Form Section (hidden input for upload button) */}
            ...
            <div className="p-8">
              <form className="space-y-8" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col gap-2 mb-4">
                  <label className="block text-sm font-medium text-gray-900">Select Images <span className="text-rose-500">*</span></label>
                  <input
                    type="file"
                    onChange={handleFileChange}
                    multiple
                    accept="image/*"
                    className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none focus:ring-2 focus:ring-rose-200 focus:border-rose-400"
                  />
                  <span className="text-xs text-gray-400 mt-1">Supported: JPG, PNG, WEBP. Max 5MB per image. Up to 5 images.</span>
                </div>
                {/* Submit Button */}
