...
export default function UploadProduct() {
  ...
  const removeImage = (idx: number) => {
    ...
    // Reset analysis when main image is removed
    if (idx === 0) {
      setImageAnalysis(null);
      setSuggestedTags([]);
    }
            ...
            <div className="fixed inset-0 flex items-center justify-center z-50">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 max-w-md w-full mx-4 relative z-10 animate-scale-up border border-gray-100">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-8">{files.length} image{files.length !== 1 ? 's' : ''} uploaded successfully.</p>
                  
                  {previews.length > 0 && (
                    <div className="flex flex-wrap gap-3 justify-center mb-6">
                      {previews.map((src, i) => (
                        <div key={i} className="relative group overflow-hidden rounded-xl shadow-sm border border-gray-200">
                          <img 
                            src={src} 
                            alt="Preview" 
              ...
              <form className="space-y-10" onSubmit={handleSubmit}>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm text-gray-500 px-3 py-1.5 bg-gray-50 rounded-full">Max 5 images</span>
                  </div>
                  ...
                  >
                    {previews.length === 0 ? (
                      <div className="w-full flex flex-col items-center justify-center text-center p-8">
                        ...
                        <p className="text-gray-900 font-medium text-lg mb-2">Drag and drop your images here</p>
                      ...
                      <>
                        ...
                        <button
                          type="button"
                          onClick={() => dropRef.current?.querySelector('input')?.click()}
                          className="w-36 h-36 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-400 hover:text-rose-500 hover:border-rose-200 transition-colors hover:bg-rose-50/30"
                        >
                        ...
                        {imageAnalysis.colors && (
                          <div>
                            ...
                            <div className="flex gap-2 flex-wrap">
                              {imageAnalysis.colors.split(',').map((color, index) => (
                                <span 
                                  key={index} 
