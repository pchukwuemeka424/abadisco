...
-- This field stores the address obtained from reverse geocoding the coordinates

-- Add detected_address column to businesses table
...
-- Create an index for detected_address for better query performance
